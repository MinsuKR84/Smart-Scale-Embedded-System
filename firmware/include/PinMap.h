...
#define PIN_HX_L_DT     3   // PD3, HX711 left DT
#define PIN_HX_L_SCK    4   // PD4, HX711 left SCK

#define PIN_LED_B       5   // PD5, PCB LED_B
#define PIN_LED_G       6   // PD6, PCB LED_G
#define PIN_LED_R       7   // PD7, PCB LED_R

#define PIN_HX_R_DT     A0  // PC0 / ADC0, HX711 right DT
#define PIN_HX_R_SCK    A1  // PC1 / ADC1, HX711 right SCK
